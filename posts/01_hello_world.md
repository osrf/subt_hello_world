...
While prototyping and experimentation happen on a local developer's computer, all solutions must be submitted to CloudSim (the cloud-based simulation environment discussed [here](https://github.com/osrf/subt/wiki/Cloudsim%20Architecture)) to join the leaderboards and compete for the prize money.
...
Before installing docker, take a look at the [system requirements](https://github.com/osrf/subt/wiki/System%20Requirements).
...
If you don't already have `docker` installed on your system, then it's best to follow the installation instructions in the [Installation Wiki](https://github.com/osrf/subt/wiki/Docker%20Install).
...
More detailed information on how to use the controller to control robots in the SubT Simulator can be found [here](https://github.com/osrf/subt/wiki/Example%20Setup).
...
* [SubT Virtual Testbed Repository](https://github.com/osrf/subt): hosts source code for the testbed
